// b59bd9a9dd316b85bb0137cbb75d5fa3

// api.openweathermap.org/data/2.5/weather?q={city name}&appid={API key}

const weatherApi={
    key: "b59bd9a9dd316b85bb0137cbb75d5fa3",
...
function showWeatherReport(weather){
    ...
    minMaxTemp= `${Math.floor(weather.main.temp_min)}&deg;C (min)/ ${Math.ceil(weather.main.temp_max)}&deg;C (max)`;
    ...
    if(weatherType.textContent== 'clear'){
        ...
        document.body.style.backgroundImage= "url('img/thunderstrome.jpg')";
    }
